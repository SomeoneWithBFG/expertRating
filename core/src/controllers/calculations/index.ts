...
class Calculations implements ICalculations {
  pairComparsion(req: Request, res: Response) {
    const result = CalculationsService.pairComparsion(
  ...
  sequentiallyComparison(req: Request, res: Response) {
    const result = CalculationsService.sequentiallyComparison(
  ...
  weighing(req: Request, res: Response) {
    const result = CalculationsService.weighing(
      req.body.inputMatrix,
      req.body.x,
      req.body.y
    );
  ...
  preference(req: Request, res: Response) {
    const result = CalculationsService.preference(
      req.body.inputMatrix,
      req.body.x,
      req.body.y
    );
  ...
  kondorse(req: Request, res: Response) {
    const result = CalculationsService.kondorse(
      req.body.inputMatrix,
      req.body.x,
      req.body.y
    );
  ...
  kemeniSnella(req: Request, res: Response) {
    const result = CalculationsService.kemeniSnella(
      req.body.inputMatrix,
      req.body.x,
      req.body.y
    );
