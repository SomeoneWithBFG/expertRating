...
export const getters = {
    ...
    pairComparsion(){
        ...
        var objToReturn = {
            values: Array(binaryMatrix.length).fill(0),
            sumOfValues: 0,
            weights: Array(binaryMatrix.length).fill(0),
            order: "",
        }
        for (var i = 0; i < 4; i++) {
            for (var j = 0; j < 4; j++) {
    ...
    sequentiallyComparison() {
        var rawEvaluations = [ 
            {index: "z1", weight: 100, resultWeight: 0}, 
            {index: "z3", weight: 60, resultWeight: 0}, 
            {index: "z4", weight: 40, resultWeight: 0}, 
            {index: "z2", weight: 10, resultWeight: 0}, 
        ];
        var objToReturn = {
            causedCorrections: "",
        ...
        var numOfEl = rawEvaluations.length;
        var weightToAdd = 25;
    ...
    preference() {
        ...
        var objToReturn = {
            modMatrix: createMatrix(inputArray.length, inputArray[0].length),
            sumMarks: Array(inputArray[0].length).fill(0),
            sumOfMarks: 0,
            weights: Array(inputArray[0].length),
            order: "",
        }
        for (var i = 0; i < 6; i++) {
            for (var j = 0; j < 2; j++) {
    ...
    kondorse() {
        ...
        var numOfEl = inputArray.length
        var objToReturn = {
            modMatrix: createMatrix(numOfEl, numOfEl),
            best: 0,
        }
        for (var i = 0; i < 5; i++) {
            for (var j = 0; j < 5; j++) {
    ...
    kemeniSnella() {
        ...
        var numOfExperts = inputArray.length;
        var numOfProjects = inputArray[0].length;
        var objToReturn = {
            binaryMatrixArray: [],
            looseMatrix: [],
            order: "",
